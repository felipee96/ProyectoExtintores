      ...
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          <div class="card-header card-header-primary text-center">
            <h4 class="card-title"><strong>{{ __('Síguenos en: ') }}</strong></h4>
          ...
          <div class="card-body">
            <p class="card-description text-center">{{ __('Inicia sesión con ') }} <strong>admin@material.com</strong> {{ __(' y contraseña ') }}<strong>secreta</strong> </p>
