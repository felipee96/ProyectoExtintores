                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST" action="/unidad/{{$item->id}}">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input value="{{$item->unidad_medida}}" type="text" class="form-control"
                                                                                id="unidad_medida" required name="unidad_medida">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="cantidad_medida">{{__('Cantidad')}}</label>
                                                                            <input value="{{$item->cantidad_medida}}" type="text" class="form-control" id="cantidad_medida" required
                                                                                name="cantidad_medida">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="sub_categoria_id">{{ __('Seleccionar Subcategoria') }}</label>
                                                                           <select class="form-control" name="sub_categoria_id" id="sub_categoria_id">
                                                                                <option value="{{$item->id}}">---{{$item->SubCategoria->nombre_subCategoria}}---</option>
                                                                                @foreach (SubCategoria() as $data)
                                                                                <option value="{{ $data->id }}">{{ $data->nombre_subCategoria }}
                                                                                    <h2>{{ $data->abreviacion }}</h2>
                                                                                </option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
