@extends('layouts.app', ['activePage' => 'adicionales', 'titlePage' => __('Gestión de Actividades')])
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url('/actividad') }}">
                                ...
                                <div class="form-group">
                                    <label for="nombre_actividad">{{ __('Nombre de la actividad:') }}</label>
            ...
            <div class="col-md-12">
                <div class="container">
                    <div class="card">
                        <div class="card-header card-header-text card-header-warning">
                            <div class="card-text">
                                <h4 class="card-title">{{ __('Ver Actividades Registradas') }}</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="example">
                                <thead>
                                    <tr class="text-center">
                                        <th>{{ __('Nombre de la actividad') }}</th>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form method="POST" action="/actividad/{{$item->id}}">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="nombre_actividad">{{ __('Nombre de la actividad:') }}</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label
                                                                            for="abreviacion_actividad">{{ __('Abreviacion:') }}</label>
                                                                        <input type="text" class="form-control"
